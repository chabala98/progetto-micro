...
/**
 * @brief   Returns the last reflected light value measured by the chosen sensor
 *
 * @param sensor_number		0-7
 *
 * @return					Last reflected light value measured by the sensor
 */

int get_reflected(unsigned int sensor_number);
