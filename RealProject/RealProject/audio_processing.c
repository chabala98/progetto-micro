...
#define FREQ_GREEN	19 //10Hz
#define FREQ_BLUE	23//50Hz
#define FREQ_RED		26//100Hz
...
void sound_remote(float* data){
	...
	chprintf((BaseSequentialStream *)&SD3, "max norm %d e vale %f\r\n\n",max_norm_index,data[max_norm_index]);
